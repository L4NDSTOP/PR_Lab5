...
public class App {
    ...
    public Session initSMTP(){
        String hostSMTP = "smtp.gmail.com"; //transmite si primeste emailuri
        int port = 465;
    ...
    public Store initIMAP() throws MessagingException {
        Properties prop = new Properties(); //stocheaza,salveaza emailurile pe server
    ...
    public Store initPOP3() throws MessagingException {
        Properties prop = new Properties();//stocheaza datele pe un dispozitiv
